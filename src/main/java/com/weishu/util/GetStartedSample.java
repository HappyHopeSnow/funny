...
public class GetStartedSample {
    ...
    private static String accessKeyId = "LTAIQbRWr3h1BmH4";
    private static String accessKeySecret = "QzFPZTVJEfiJX4kF1wNxc1nGph9LGf";
    private static String bucketName = "weishu-funny";
    private static String key = "abcKey";
